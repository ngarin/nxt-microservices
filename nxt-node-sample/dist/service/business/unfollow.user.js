...
class Unfollow extends user_controller_1.UserController {
    init(me, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isUserFollowed = userMe.following.some(id => mongoose_1.Types.ObjectId(userId).equals(id));
            if (!isUserFollowed) {
                throw new error_handler_helper_1.ErrorHandler(http_status_codes_enum_1.EHttpStatusCodes.notFound, 'User not followed');
            }
            userMe.following = userMe.following.filter(id => !mongoose_1.Types.ObjectId(userId).equals(id));
            yield userMe.save();
            return yield user_repo_1.default.findById(me._id);
        });
    }
}
exports.default = new Unfollow();
